...
@Table(
  ...
  indexes = {
    ...
    @Index(columnList = "meta_model"),
    @Index(columnList = "meta_json_model")
  }
)
public class Template extends AuditableModel {
   ...
   *
   * <p>It sets {@code item.template = this} to ensure the proper relationship.
   *
   ...
   *
   * <p>If you have to query {@link TemplateContext} records in same transaction, make sure to call
   * {@link javax.persistence.EntityManager#flush() } to avoid unexpected errors.
   */
