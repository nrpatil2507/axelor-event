...
public class MessageRepository extends JpaRepository<Message> {
  ...
  public Query<Message> findByRelatedTo(long relatedToSelectId, String relatedToSelect) {
    return Query.of(Message.class)
        .filter(
            "self.relatedTo1SelectId = :relatedToSelectId		 AND self.relatedTo1Select = :relatedToSelect	   OR self.relatedTo2SelectId = :relatedToSelectId		 AND self.relatedTo2Select = :relatedToSelect")
