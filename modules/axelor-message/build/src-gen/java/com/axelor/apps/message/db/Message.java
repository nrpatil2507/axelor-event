...
@Table(
  ...
  indexes = {
    ...
    @Index(columnList = "from_email_address"),
    @Index(columnList = "mail_account"),
    @Index(columnList = "sender_user"),
    @Index(columnList = "recipient_user"),
    @Index(columnList = "template")
  }
)
public class Message extends AuditableModel {
  ...
  @SequenceGenerator(
    ...
    sequenceName = "MESSAGE_MESSAGE_SEQ",
    allocationSize = 1
  )
  private Long id;
  ...
  public Message(
      ...
      Integer mediaTypeSelect,
      String addressBlock,
      EmailAddress fromEmailAddress,
      Set<EmailAddress> replyToEmailAddressSet,
      Set<EmailAddress> toEmailAddressSet,
      Set<EmailAddress> ccEmailAddressSet,
      Set<EmailAddress> bccEmailAddressSet,
      Boolean sentByEmail,
