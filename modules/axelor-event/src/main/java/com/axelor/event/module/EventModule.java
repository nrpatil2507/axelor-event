...
import com.axelor.event.db.repo.EventRegistrationManagementRepository;
...
public class EventModule extends AxelorModule {
  ...
  protected void configure() {
    ...
    bind(EventRegistrationRepository.class).to(EventRegistrationManagementRepository.class);
  }
}
